...
export default function DashboardPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-sweetBrown">Dashboard</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-500">+$4,350</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-500">-$1,430</div>
            <p className="text-xs text-muted-foreground">-2% desde el mes pasado</p>
          </CardContent>
        </Card>
      </div>
